...
def sample_ingredient(user, name='Honey'):
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_ingredients(self):
        """ Test returning ingredients with specific tags. """
        recipe1 = sample_recipe(user=self.user, title='Beans on Toast')
        recipe2 = sample_recipe(user=self.user, title='Split Pea Soup')
        ingredient1 = sample_ingredient(user=self.user, name='Beans')
        ingredient2 = sample_ingredient(user=self.user, name='Peas')
