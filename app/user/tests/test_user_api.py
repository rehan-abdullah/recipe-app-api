...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        ...
        payload = {'email': 'test@djangouser.com', 'password': 'testpass'}
        create_user(**payload)
    ...
    def test_password_too_short(self):
        """Test the password is more than 5 characters"""
        payload = {
            'email': 'test@djangouser.com',
            'password': 'pw',
            'name': 'Test',
    ...
    def test_create_token_for_user(self):
        ...
        payload = {'email': 'test@django.com', 'password': 'testpass'}
        create_user(**payload)
